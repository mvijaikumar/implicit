...
static PyObject *__pyx_pw_8implicit_4cuda_5_cuda_20CuLeastSquaresSolver_3least_squares(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_cui,&__pyx_n_s_X,&__pyx_n_s_Y,&__pyx_n_s_regularization,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("least_squares", 1, 4, 4, 1); __PYX_ERR(1, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("least_squares", 1, 4, 4, 2); __PYX_ERR(1, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_regularization)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("least_squares", 1, 4, 4, 3); __PYX_ERR(1, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("least_squares", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 54, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_8implicit_4cuda_5_cuda_20CuLeastSquaresSolver_2least_squares(((struct __pyx_obj_8implicit_4cuda_5_cuda_CuLeastSquaresSolver *)__pyx_v_self), __pyx_v_cui, __pyx_v_X, __pyx_v_Y, __pyx_v_regularization);
...
static PyObject *__pyx_pf_8implicit_4cuda_5_cuda_20CuLeastSquaresSolver_2least_squares(struct __pyx_obj_8implicit_4cuda_5_cuda_CuLeastSquaresSolver *__pyx_v_self, struct __pyx_obj_8implicit_4cuda_5_cuda_CuCSRMatrix *__pyx_v_cui, struct __pyx_obj_8implicit_4cuda_5_cuda_CuDenseMatrix *__pyx_v_X, struct __pyx_obj_8implicit_4cuda_5_cuda_CuDenseMatrix *__pyx_v_Y, float __pyx_v_regularization) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
 ...
 */
  try {
    __pyx_v_self->c_solver->least_squares((*__pyx_v_cui->c_matrix), __pyx_v_X->c_matrix, (*__pyx_v_Y->c_matrix), __pyx_v_regularization);
  } catch(...) {
    __Pyx_CppExn2PyErr();
